...
public:
    ...
    void setupUi(QWidget *ContactItem)
    {
        ...
        verticalSpacer = new QSpacerItem(150, 5, QSizePolicy::Minimum, QSizePolicy::Expanding);
        ...
        verticalSpacer_2 = new QSpacerItem(150, 5, QSizePolicy::Minimum, QSizePolicy::Expanding);
