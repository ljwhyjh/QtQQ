...
public:
    ...
    void setupUi(QWidget *TalkWindow)
    {
        ...
        sizePolicy3.setHeightForWidth(addtoolbtn->sizePolicy().hasHeightForWidth());
        addtoolbtn->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(addhumanBtn->sizePolicy().hasHeightForWidth());
        addhumanBtn->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(appBtn->sizePolicy().hasHeightForWidth());
        appBtn->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(videoBtn->sizePolicy().hasHeightForWidth());
        videoBtn->setSizePolicy(sizePolicy3);
        ...
        sizePolicy3.setHeightForWidth(toolsetBtn->sizePolicy().hasHeightForWidth());
        toolsetBtn->setSizePolicy(sizePolicy3);
        ...
        sizePolicy4.setHeightForWidth(frameWidget->sizePolicy().hasHeightForWidth());
        frameWidget->setSizePolicy(sizePolicy4);
        ...
        bottomWidget->setMinimumSize(QSize(0, 137));
        ...
        sendBtn->setProperty("titileskin", QVariant(true));
